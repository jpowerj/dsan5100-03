...
format:
  revealjs:
    ...
    footer: "DSAN 5100-03 W09: Statistical Inference"
...
## Finite-State Automata {.nostretch .crunch-title .smaller-table}
...
## Enter Markov Chains {.crunch-title .math-90 .crunch-math}
...
## The PageRank Process {.smaller .crunch-title .crunch-ul}
...
* This $\mathbf{r}^*$ is (by definition!) an **Eigenvector** of $\mathbf{E}$ with **Eigenvalue** $\lambda = 1$![^lambda]
...
## The Point of All This {.crunch-title .crunch-ul}
...
## Zooming in on Euclid {.smaller .crunch-figures .crunch-title}
...
![Interactive visualization from [UNC Archaeology](https://archaeology.sites.unc.edu/home/rla/){target='_blank'}](images/arrowhead.jpeg){fig-align="center" width="30%"}
...
## Interactive Visualization {.smaller .crunch-title}

![[*Seeing Theory*, Brown University](https://seeing-theory.brown.edu/basic-probability/index.html){target='_blank'}](images/seeing-theory.jpeg){fig-align="center"}
...
## The Sample Mean {.crunch-title .crunch-math .crunch-ul .math-90 .inline-90 .crunch-li-8}
...
[^cap-lower]: Note the capital $N$ for **cardinality** of observations, vs. (lowercase) $1, 2, \ldots, n$ for **ordinal labels** on each observation. This will spare you many headaches!

## Weak Law of Large Numbers (WLLN) {.crunch-title .crunch-math .crunch-ul .math-80 .inline-90}
...
## Strong Law of Large Numbers (SLLN) {.crunch-title .crunch-math .crunch-ul .math-90 .inline-90 .crunch-li-8}
...
## When is $\mathcal{N}(0, 1)$ a "good" approximation? {.smaller .title-12 .crunch-title .crunch-code .crunch-figures .crunch-img .crunch-quarto-layout-panel}
...
1\. What are the individual $\Pr(x_i \mid \param{p})$ terms?<br>
...
* [Link here](https://colab.research.google.com/drive/1o8cHv3T2zcfXOguIQ8NTxphtt62WSL98#scrollTo=RU91KcT9NHHA){target='_blank'}
