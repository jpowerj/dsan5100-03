...
## Enter Markov Chains {.crunch-title}
...
```{=html}
<iframe src="https://seeing-theory.brown.edu/basic-probability/index.html" width="100%" height="500px"></iframe>
```

[*Seeing Theory*, Brown University](https://seeing-theory.brown.edu/basic-probability/index.html){target='_blank'}
:::
...
## The Sample Mean {.crunch-title .crunch-math .crunch-ul .math-90}
...
## Strong Law of Large Numbers (SLLN) {.crunch-title .crunch-math .crunch-ul .math-90 .small-inline}
...
## Obstacle: Products vs. Sums {.smaller .crunch-title}
...
## Math Magic 3: Log-Likelihood {.crunch-title}
