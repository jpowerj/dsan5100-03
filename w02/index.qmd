...
```{=html}
<style>
  .crunch-figures .quarto-figure {
    margin-bottom: 0 !important;
}
.crunch-figures figcaption {
...
.crunch-layout-panel .quarto-layout-panel {
  margin-bottom: 0px !important;
}
.crunch-lists li {
...
.crunch-math .MathJax_Display {
    margin-top: 0px !important;
    margin-bottom: 0px !important;
}
.crunch-math .math.display {
  margin-top: 0px !important;
  margin-bottom: 0px !important;
}
...
[^iso]: For math majors, you can think of it as an **isomorphism** between the objects and operations of the three subjects
...
* Probability theory lets us reason about the **uncertainty** surrounding **logical** predicates like $p$ and $q$, by:
  ...
  (b) representing the uncertainty around any given possibility using a **probability measure** $\Pr: S \mapsto [0,1]$,
...
## Flipping Two Coins: Logic $\rightarrow$ Probability {.smaller}
...
## Moving from Predicates to Formulas {.smaller .crunch-table .crunch-math}
...
| - |:- |:- |
| $f_1 = p_1 \wedge q_2$ | $$ \begin{align*} F_1 &= P_1 \cap Q_2 \\ &= \{HT, HH\} \cap \{TT, HT\} \\ &= \{HT\} \end{align*} $$ | $$\begin{align*} \Pr(F_1) &= \Pr(\{HT\}) \\ &= \frac{|\{HT\}|}{|S|} = \frac{1}{4} \end{align*}$$ |
...
| $f_3 = \neg p_1$ | $$\begin{align*} F_3 &= P_1^c \\ &= \{HT, HH\}^c \\ &= \{TT, TH\}\end{align*}$$ | $$\begin{align*} \Pr(F_3) &= \Pr(\{TT, TH\}) \\ &= \frac{|\{TT, TH\}|}{|S|} = \frac{2}{4} = \frac{1}{2} \end{align*}$$ |

## Using "Rules" of Probability {.smaller .crunch-math .crunch-title}
...
## "Importing" Results from Logic {.crunch-math}
...
## Doing Math with Events {.smaller .crunch-title .crunch-math}
...
## Example: The Normal Distribution {.smaller .crunch-figures}
...
## Real Data and the 68-95-99.7 Rule {.smaller .crunch-layout-panel .crunch-title .crunch-figures .crunch-lists .crunch-images}
...
::: {#fig-empirical}
<img src="images/empirical_rule.svg" height="333">
...
## Boxplots: Comparing Multiple Distributions {.smaller .small-title}

::: {layout-ncol=2}

![<a href="https://commons.wikimedia.org/wiki/File:Boxplot_vs_PDF.svg">Jhguch at en.wikipedia</a>, <a href="https://creativecommons.org/licenses/by-sa/2.5">CC BY-SA 2.5</a>, via Wikimedia Commons](images/boxplot_vs_pdf.svg)

![<a href="https://commons.wikimedia.org/wiki/File:Boxplot_of_Average_Article_Feedback_ratings_by_project_rated_quality.svg">Protonk</a>, <a href="https://creativecommons.org/licenses/by-sa/3.0">CC BY-SA 3.0</a>, via Wikimedia Commons](images/multiple_boxplots.svg)
...
<img src="images/manifesto_distances.png" height="550"></img>
...
## Multivariate Distributions: Preview {.smaller}
